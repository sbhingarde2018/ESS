...
public class MaxCasualLeavethatcanbeavailedforinstance extends BasePage{
	...
	@FindBy(xpath="//input[@id='leave_policy_head_wise_setting_behaviour_settings_max_days_applied']")
	WebElement MaxLeaveAppliedPerInstance;
	...
	public MaxCasualLeavethatcanbeavailedforinstance(WebDriver driver) {
		super(driver);
	...
	public void maxLeaveAppliedPerInstance(String un) throws Exception{
		MaxLeaveAppliedPerInstance.sendKeys(un);
		}
