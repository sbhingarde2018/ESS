...
public class Priordaytoapplycasualleave  extends BasePage {
	...
	@FindBy(xpath="//input[@id='leave_policy_head_wise_setting_behaviour_settings_prior_days']")
	...
	public Priordaytoapplycasualleave(WebDriver driver) {
		super(driver);
	...
	public void priordays(String un) throws Exception{
		priordays.sendKeys(un);
		}
