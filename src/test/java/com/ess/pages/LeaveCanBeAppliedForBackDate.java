...
public class LeaveCanBeAppliedForBackDate extends BasePage {
	...
	@FindBy(xpath="//table[@class='table all-white no-border gen_text']//input[@id='leave_policy_head_wise_setting_behaviour_settings_backdate']")
	WebElement backday;
	...
	@FindBy(xpath="//li[contains(text(),'Leave can be applied for back date, if the Apr')]")
	WebElement successfullMessageForLeave;

	
	public LeaveCanBeAppliedForBackDate(WebDriver driver) {
		super(driver);
	...
	public void backday() throws Exception{
		backday.click();
		}
