...
public class MinimumNodaysshouldbeappliedtoavailtheCasualLeave extends BasePage{
	...
	@FindBy(xpath="//input[@id='leave_policy_head_wise_setting_behaviour_settings_min_days_applied']")
	WebElement MinNoAvailtheLeave;
	...
	public MinimumNodaysshouldbeappliedtoavailtheCasualLeave(WebDriver driver) {
		super(driver);
	...
	public void MinNoAvailtheLeave(String un) throws Exception{
		MinNoAvailtheLeave.sendKeys(un);
		}
