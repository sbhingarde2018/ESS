...
public class Bonus extends BaseTest {
	...
	@Test(priority=7)
 	public void AddNewBonusDefinition_SC_638() throws Exception{
		...
		sh.selectBonus();
		sh.clickAddNewBonus();
		sh.EnterBonusHead("Eid");
		sh.clickManual();
		sh.EnterMaxBonus("1000");
		sh.SelectFromMonth("Mar/2019");
		sh.SelectToMonth("Apr/2019");
		sh.SelectPaymonth("Apr/2019");
		sh.clickCreateBonus();
	...
	public void AddNewBonusDefinitionMaxBonus_SC_639() throws Exception{
		...
		cb.selectBonus();
		cb.clickAddNewBonus();
		cb.EnterBonusHead("Eid1");
		cb.EnterMaxBonus("10000");
		cb.SelectFormula("Bonus");
		cb.SelectFromMonth("Mar/2019");
		cb.SelectToMonth("Apr/2019");
		cb.SelectPaymonth("Apr/2019");
		cb.checksalarydependent();
		cb.checknearestrupee();
		cb.clickCreateBonus();
		String t=cb.getMessage();
...
@Test(priority=19)
	...
	public void AddNewBonusDefinitionMaxBonusModeofPaymentCash_SC_659() throws Exception{
		...
		ad.selectBonus();
		ad.clickAddNewBonus();
		ad.EnterBonusHead("Navratri4");
		ad.selectformula("Bonus");
		ad.EnterMaxBonus("10000");
		ad.SelectFromMonth("Apr/2019");
		ad.SelectToMonth("Apr/2019");
		ad.SelectPaymonth("Apr/2019");
