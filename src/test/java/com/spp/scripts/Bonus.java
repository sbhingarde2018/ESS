...
/*	@Test(priority=0)
	public void AddNewBonusDefinitionForFormula_SC_340() throws Exception{
		...
		cb.SelectFromMonth("Apr/2013");
		cb.SelectToMonth("May/2013");
		cb.SelectPaymonth("May/2013");
	...
	@Test(priority=2)
 	public void CheckBonusInGeneratedReport_SC_349() throws Exception{
		...
		sh.clickReports("Bonus Definition");
		sh.clickMonthYear("Apr/2018");
		sh.clickGetEmployee();
		Thread.sleep(2000);
		sh.clickGetLoad();
		Thread.sleep(3000);
...
//		Thread.sleep(3000);
	...
	@Test(priority=7)
 	public void AddNewBonusDefinition_SC_638() throws Exception{
		...
		sh.selectBonus();
		sh.clickAddNewBonus();
		sh.EnterBonusHead("Dasara_"+Utility.getRandNum(1, 1000));
		sh.clickManual();
		sh.EnterMaxBonus("1000");
		sh.SelectFromMonth("Jan/2017");
		sh.SelectToMonth("Apr/2018");
		sh.SelectPaymonth("Apr/2018");
		sh.clickCreateBonus();
	...
	public void AddNewBonusDefinitionMaxBonusModeofPaymentCash_SC_659() throws Exception{
		...
		ad.SelectToMonth("May/2013");
		ad.SelectPaymonth("May/2013");
