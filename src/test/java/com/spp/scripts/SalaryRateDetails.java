...
public class SalaryRateDetails extends BaseTest {
	...
	@Test(priority=1)  //chang emp for alloted salary ---CalcTyp NotApplicable f
	...
	/*	rr.selectAllotSalaryButton();
		Thread.sleep(3000);
		rr.selectEffectiveFrom("Nov/2019");
		Thread.sleep(3000);
		rr.selectGetRate();
		Thread.sleep(3000);
		rr.enterGrossSal("40000");
