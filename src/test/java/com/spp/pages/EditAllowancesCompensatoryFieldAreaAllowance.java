...
public class EditAllowancesCompensatoryFieldAreaAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[62]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement CompensatoryAllowanceGiven;
	...
	public EditAllowancesCompensatoryFieldAreaAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickCompensatoryAllowanceGiven() {
		CompensatoryAllowanceGiven.click();
	}
