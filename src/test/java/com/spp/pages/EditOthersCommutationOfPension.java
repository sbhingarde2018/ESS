...
public class EditOthersCommutationOfPension extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement CommutationOfPension;
	...
	public EditOthersCommutationOfPension(WebDriver driver) {
		super(driver);
	...
	public void ClickCommutationOfPension() {
		CommutationOfPension.click();
	}
