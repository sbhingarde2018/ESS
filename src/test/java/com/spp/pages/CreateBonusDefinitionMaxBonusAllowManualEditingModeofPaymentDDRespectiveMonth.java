...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentDDRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentDDRespectiveMonth(WebDriver driver) {
		super(driver);
