...
public class EditOthersSalaryReceivedFromUNO extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	public EditOthersSalaryReceivedFromUNO(WebDriver driver) {
		super(driver);
	...
	public void ClickSalaryFromUNO() {
		SalaryFromUNO.click();
	}
