...
public class CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingNearest10Rupee(WebDriver driver) {
		super(driver);
