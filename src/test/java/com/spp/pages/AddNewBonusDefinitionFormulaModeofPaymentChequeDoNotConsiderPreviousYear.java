...
public class AddNewBonusDefinitionFormulaModeofPaymentChequeDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionFormulaModeofPaymentChequeDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
