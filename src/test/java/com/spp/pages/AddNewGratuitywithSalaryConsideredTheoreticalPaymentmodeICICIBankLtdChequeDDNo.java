...
public class AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeICICIBankLtdChequeDDNo extends BasePage {
	@FindBy(id="salary")
	...
	public AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeICICIBankLtdChequeDDNo(WebDriver driver) {
		super(driver);
