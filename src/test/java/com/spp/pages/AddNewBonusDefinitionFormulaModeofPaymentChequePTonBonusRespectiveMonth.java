...
public class AddNewBonusDefinitionFormulaModeofPaymentChequePTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionFormulaModeofPaymentChequePTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
