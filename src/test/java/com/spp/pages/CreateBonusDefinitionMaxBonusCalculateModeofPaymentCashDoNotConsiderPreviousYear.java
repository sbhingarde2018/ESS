...
public class CreateBonusDefinitionMaxBonusCalculateModeofPaymentCashDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusCalculateModeofPaymentCashDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
