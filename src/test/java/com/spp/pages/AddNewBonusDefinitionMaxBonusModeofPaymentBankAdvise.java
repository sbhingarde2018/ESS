...
public class AddNewBonusDefinitionMaxBonusModeofPaymentBankAdvise extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri5')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public AddNewBonusDefinitionMaxBonusModeofPaymentBankAdvise(WebDriver driver) {
		super(driver);
