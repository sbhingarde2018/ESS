...
public class CreateBonusDefinitionMaxBonusFormulaConsideremployeeswithminimumworkingModeofPaymentCash extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri3')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionMaxBonusFormulaConsideremployeeswithminimumworkingModeofPaymentCash(WebDriver driver) {
		super(driver);
