...
public class CreateBonusDefinitionFormulaCalculateModeofPaymentChequeNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Diwali247')]/parent::tr/td[4]/a/img")
	...
	public CreateBonusDefinitionFormulaCalculateModeofPaymentChequeNearest10Rupee(WebDriver driver) {
		super(driver);
	...
	public void selectrespectivemonthconsiderpreviousyear() {
