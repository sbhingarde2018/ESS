...
public class SaveIncomeFromOtherSourcesInterestonSecurities extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(id="income_from_other_sources_interest_on_securities_net_amount")
	WebElement NetAmount;
	@FindBy(id="income_from_other_sources_interest_on_securities_exemption")
	...
	public SaveIncomeFromOtherSourcesInterestonSecurities(WebDriver driver) {
		super(driver);
