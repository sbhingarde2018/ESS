...
public class CreateBonusDefinitionConsideremployeeswithminimumworkingPTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionConsideremployeeswithminimumworkingPTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
