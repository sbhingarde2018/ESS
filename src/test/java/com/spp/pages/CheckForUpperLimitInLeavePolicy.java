...
public class CheckForUpperLimitInLeavePolicy extends BasePage {
	@FindBy(id="master")
   ...
   // @FindBy(xpath="//*[@id=\"leave_policy_setting_details\"]/div[2]/table/tbody/tr/td[2][contains(text(),'Earned')]/parent::tr/td[3]/a")
    ...
    @FindBy(xpath="//*[@id=\"excess_div\"]/table/tbody/tr[1]/td[2]/label/input[2]")
    WebElement UpperBoxvalue;
	...
	public void enterUpperBoxvalue(String value) {
		UpperBoxvalue.sendKeys(value);
