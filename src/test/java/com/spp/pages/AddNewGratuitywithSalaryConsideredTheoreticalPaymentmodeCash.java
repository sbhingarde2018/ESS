...
public class AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeCash extends BasePage {
	@FindBy(id="salary")
	...
	public AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeCash(WebDriver driver) {
		super(driver);
