...
public class CheckAdvanceMstrwithReducingBal extends BasePage{
	...
	@FindBy(xpath="//div[2]/table/tbody/tr/td[contains(text(),'Advance_Master22')]/parent::tr/td[4]/a")
	...
	public CheckAdvanceMstrwithReducingBal(WebDriver driver){
		super(driver);
