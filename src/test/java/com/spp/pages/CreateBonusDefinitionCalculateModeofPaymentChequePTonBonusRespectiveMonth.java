...
public class CreateBonusDefinitionCalculateModeofPaymentChequePTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionCalculateModeofPaymentChequePTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
