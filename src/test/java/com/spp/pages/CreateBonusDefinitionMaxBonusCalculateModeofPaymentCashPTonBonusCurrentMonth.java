...
public class CreateBonusDefinitionMaxBonusCalculateModeofPaymentCashPTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusCalculateModeofPaymentCashPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
