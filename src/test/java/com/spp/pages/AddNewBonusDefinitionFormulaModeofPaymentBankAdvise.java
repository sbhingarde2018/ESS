...
public class AddNewBonusDefinitionFormulaModeofPaymentBankAdvise extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri6')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public AddNewBonusDefinitionFormulaModeofPaymentBankAdvise(WebDriver driver) {
		super(driver);
