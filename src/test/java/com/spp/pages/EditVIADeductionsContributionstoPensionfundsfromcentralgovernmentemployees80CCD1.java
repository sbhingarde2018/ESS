...
public class EditVIADeductionsContributionstoPensionfundsfromcentralgovernmentemployees80CCD1 extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement ContributionstoPensionfundsfromcentralgovernmentemployees80CCD1;
	...
	public EditVIADeductionsContributionstoPensionfundsfromcentralgovernmentemployees80CCD1(WebDriver driver) {
		super(driver);
	...
	public void ClickDeductions() {
		ContributionstoPensionfundsfromcentralgovernmentemployees80CCD1.click();
	}
