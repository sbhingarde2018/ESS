...
public class AddNewBonusDefinitionAllowManualEditingNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionAllowManualEditingNearest10Rupee(WebDriver driver) {
		super(driver);
