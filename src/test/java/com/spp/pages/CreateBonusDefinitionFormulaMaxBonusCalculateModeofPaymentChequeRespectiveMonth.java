...
public class CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentChequeRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentChequeRespectiveMonth(WebDriver driver) {
		super(driver);
