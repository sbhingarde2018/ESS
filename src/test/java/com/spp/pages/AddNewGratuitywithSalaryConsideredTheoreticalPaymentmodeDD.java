...
public class AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeDD extends BasePage {
	@FindBy(id="salary")
	...
	public AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeDD(WebDriver driver) {
		super(driver);
