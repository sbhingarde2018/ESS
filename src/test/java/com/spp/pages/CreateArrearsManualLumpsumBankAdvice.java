...
public class CreateArrearsManualLumpsumBankAdvice extends BasePage{
	@FindBy(id="salary") 
	...
	@FindBy(id="arrear_calc_type_manual_0")
	WebElement Lumpsum;
...
public CreateArrearsManualLumpsumBankAdvice(WebDriver driver) {
		super(driver);
