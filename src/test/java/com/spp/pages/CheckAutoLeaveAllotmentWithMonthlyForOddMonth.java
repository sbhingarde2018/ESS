...
public class CheckAutoLeaveAllotmentWithMonthlyForOddMonth extends BasePage {
	@FindBy(id="master")
    ...
    @FindBy(xpath="//*[@id=\"auto_leave_allotment_div\"]/table/tbody/tr[2]/td[2]/div[1]/select")
    WebElement AllotOn;
