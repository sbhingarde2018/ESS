...
public class CreateBonusDefinitionConsideremployeeswithminimumworkingModeofPaymentDDCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionConsideremployeeswithminimumworkingModeofPaymentDDCurrentMonth(WebDriver driver) {
		super(driver);
