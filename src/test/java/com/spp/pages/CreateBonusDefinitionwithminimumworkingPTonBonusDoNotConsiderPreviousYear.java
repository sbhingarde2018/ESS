...
public class CreateBonusDefinitionwithminimumworkingPTonBonusDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionwithminimumworkingPTonBonusDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
