...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentCheque extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri19')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentCheque(WebDriver driver) {
		super(driver);
