...
public class EditAllowancesHighAltitudeAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[37]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement HighAltitudeAllowanceGiven;
	...
	public EditAllowancesHighAltitudeAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickHighAltitudeAllowanceGiven() {
		HighAltitudeAllowanceGiven.click();
	}
