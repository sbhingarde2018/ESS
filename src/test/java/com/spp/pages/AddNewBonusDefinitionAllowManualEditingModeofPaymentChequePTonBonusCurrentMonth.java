...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentChequePTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentChequePTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
