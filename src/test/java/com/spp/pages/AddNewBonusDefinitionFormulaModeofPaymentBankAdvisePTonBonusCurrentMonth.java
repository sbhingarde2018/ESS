...
public class AddNewBonusDefinitionFormulaModeofPaymentBankAdvisePTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionFormulaModeofPaymentBankAdvisePTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
