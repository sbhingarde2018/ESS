...
public class EditPerquisitesSweeper extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[43]/td[3]/a")
	WebElement Sweeper;
	...
	public EditPerquisitesSweeper(WebDriver driver) {
		super(driver);
