...
public class EditVIADeductionsMedicalinsurancepremiumpaid80DSenior extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	public EditVIADeductionsMedicalinsurancepremiumpaid80DSenior(WebDriver driver) {
		super(driver);
