...
public class AddNewBonusDefinitionFormulaModeofPaymentBankAdvisePTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionFormulaModeofPaymentBankAdvisePTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
