...
public class CreateBonusDefinitionMaxBonusConsideremployeeswithminimumworkingCalculate extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//*[@id=\"bonus_or_exgratia\"]/div/table/tbody/tr/td[contains(text(),'Holi')]/parent::tr/td[4]/a")
	WebElement DeleteButton;
	
	
	public CreateBonusDefinitionMaxBonusConsideremployeeswithminimumworkingCalculate(WebDriver driver) {
		super(driver);
