...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentCash extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentCash(WebDriver driver) {
		super(driver);
