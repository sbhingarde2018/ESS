...
public class AddNewBonusDefinitionFormulaModeofPaymentDDPTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
WebElement Salary;
...
public AddNewBonusDefinitionFormulaModeofPaymentDDPTonBonusRespectiveMonth(WebDriver driver) {
	super(driver);
