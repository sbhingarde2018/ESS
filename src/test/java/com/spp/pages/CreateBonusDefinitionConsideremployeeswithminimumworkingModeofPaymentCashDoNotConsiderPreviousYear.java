...
public class CreateBonusDefinitionConsideremployeeswithminimumworkingModeofPaymentCashDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionConsideremployeeswithminimumworkingModeofPaymentCashDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
