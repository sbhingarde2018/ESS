...
public class VIADeductionsDeductioninrespectofinterestonloanstakenforresidentialhouseproperty80EE extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement Deductioninrespectofinterestonloanstakenforresidentialhouseproperty80EE;
	...
	public VIADeductionsDeductioninrespectofinterestonloanstakenforresidentialhouseproperty80EE(WebDriver driver) {
		super(driver);
	...
	public void ClickDeductions() {
		Deductioninrespectofinterestonloanstakenforresidentialhouseproperty80EE.click();
	}
