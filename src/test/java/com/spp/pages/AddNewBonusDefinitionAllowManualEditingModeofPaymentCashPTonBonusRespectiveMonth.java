...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentCashPTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentCashPTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
