...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentChequeRespectiveMonth extends BasePage{
	...
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentChequeRespectiveMonth(WebDriver driver) {
		super(driver);
