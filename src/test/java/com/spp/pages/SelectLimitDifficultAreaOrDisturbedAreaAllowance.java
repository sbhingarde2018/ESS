...
public class SelectLimitDifficultAreaOrDisturbedAreaAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement DiffAreaAllowanceGiven;
	...
	public SelectLimitDifficultAreaOrDisturbedAreaAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickDiffAreaAllowanceGiven() {
		DiffAreaAllowanceGiven.click();
	}
