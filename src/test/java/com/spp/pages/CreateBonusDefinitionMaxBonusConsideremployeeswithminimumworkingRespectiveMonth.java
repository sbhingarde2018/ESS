...
public class CreateBonusDefinitionMaxBonusConsideremployeeswithminimumworkingRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusConsideremployeeswithminimumworkingRespectiveMonth(WebDriver driver) {
		super(driver);
