...
public class EditAllowancesChildrenHostelAllowance extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(id="CHA Given")
	WebElement HostelAllowanceGiven;
	...
	public EditAllowancesChildrenHostelAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickHostelAllowanceGiven() {
		HostelAllowanceGiven.click();
	}
