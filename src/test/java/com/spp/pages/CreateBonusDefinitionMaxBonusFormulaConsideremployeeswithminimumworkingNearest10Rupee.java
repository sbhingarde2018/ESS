...
public class CreateBonusDefinitionMaxBonusFormulaConsideremployeeswithminimumworkingNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusFormulaConsideremployeeswithminimumworkingNearest10Rupee(WebDriver driver) {
		super(driver);
