...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentCashNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Diwali223')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentCashNearest10Rupee(WebDriver driver) {
		super(driver);
