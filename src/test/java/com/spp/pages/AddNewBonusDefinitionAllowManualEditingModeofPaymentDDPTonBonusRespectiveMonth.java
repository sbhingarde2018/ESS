...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentDDPTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentDDPTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
