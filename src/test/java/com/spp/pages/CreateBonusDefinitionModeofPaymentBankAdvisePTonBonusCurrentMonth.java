...
public class CreateBonusDefinitionModeofPaymentBankAdvisePTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionModeofPaymentBankAdvisePTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
