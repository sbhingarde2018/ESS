...
public class CheckAdvancemstrwithRedBalandClubbedInSal extends BasePage{
	@FindBy(id="master")
	...
	@FindBy(xpath="//div[2]/table/tbody/tr/td[contains(text(),'Advance_Master24')]/parent::tr/td[4]/a")
	...
	public CheckAdvancemstrwithRedBalandClubbedInSal(WebDriver driver){
		super(driver);
