...
public class EditVIADeductionsInvestmentmadeunderanequitysavingsscheme80CCG extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement Investmentmadeunderanequitysavingsscheme80CCG;
	...
	public EditVIADeductionsInvestmentmadeunderanequitysavingsscheme80CCG(WebDriver driver) {
		super(driver);
	...
	public void ClickDeductions() {
		Investmentmadeunderanequitysavingsscheme80CCG.click();
	}
