...
public class EditVIADeductionsInterestpaidonhighereducationloan80E extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*/table/tbody/tr[11]/td[3]/a")
	WebElement Interestpaidonhighereducationloan80E;
	...
	public EditVIADeductionsInterestpaidonhighereducationloan80E(WebDriver driver) {
		super(driver);
	...
	public void ClickDeductions() {
		Interestpaidonhighereducationloan80E.click();
	}
