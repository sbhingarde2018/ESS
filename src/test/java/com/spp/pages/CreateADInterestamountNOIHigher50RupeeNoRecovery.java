...
public class CreateADInterestamountNOIHigher50RupeeNoRecovery extends BasePage{
	@FindBy(id="salary")
	...
	public CreateADInterestamountNOIHigher50RupeeNoRecovery(WebDriver driver){
		super(driver);
