...
public class EditPerquisitesClubExpenses extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[113]/td[2]/a")
	WebElement ClubExpenses;
	...
	public EditPerquisitesClubExpenses(WebDriver driver) {
		super(driver);
