...
public class EditVIADeductionsMedicalinsurancepremiumpaid80DSeniorIncaseifVeryseniorcitizen extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(id="six_a_deduction_sub_attr_1_senior")
	...
	@FindBy(id="six_a_deduction_sub_attr_1_senior_medical_expenditure")
	...
	public EditVIADeductionsMedicalinsurancepremiumpaid80DSeniorIncaseifVeryseniorcitizen(WebDriver driver) {
		super(driver);
