...
public class AddNewBonusDefinitionMaxBonusModeofPaymentChequePTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionMaxBonusModeofPaymentChequePTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
