...
public class CheckifSalaryPerodicIncentiveGeneralLinksEmployeeMasterredirectstoEmployee extends BasePage{
	...
	public CheckifSalaryPerodicIncentiveGeneralLinksEmployeeMasterredirectstoEmployee(WebDriver driver) {
		super(driver);
	...
	public void clickonperodicincentivedetail() {
		ClickOnPerodicIncentiveDetail.click();
	}
