...
public class EditOthersSalaryPaidtoForeignDeplomatExemptFromSalary extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement Others;
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[17]/td[2]/a")
	WebElement SalaryPaidForeignDeplomat;
	...
	public EditOthersSalaryPaidtoForeignDeplomatExemptFromSalary(WebDriver driver) {
		super(driver);
	...
	public void ClickSalaryPaidForeignDeplomat() {
		SalaryPaidForeignDeplomat.click();
	}
