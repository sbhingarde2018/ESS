...
public class EditPerquisitesOtherPerquisites extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[138]/td[2]/a")
	WebElement OtherPerquisites;
	...
	public EditPerquisitesOtherPerquisites(WebDriver driver) {
		super(driver);
	...
	public void ClickOtherPerquisites() {
		OtherPerquisites.click();
	}
