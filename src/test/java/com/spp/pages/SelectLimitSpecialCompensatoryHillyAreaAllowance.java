...
public class SelectLimitSpecialCompensatoryHillyAreaAllowance extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	public SelectLimitSpecialCompensatoryHillyAreaAllowance(WebDriver driver) {
		super(driver);
