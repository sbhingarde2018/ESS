...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentBankAdviseCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentBankAdviseCurrentMonth(WebDriver driver) {
		super(driver);
