...
public class EditVIADeductionsRoyaltyonPatents80RRB extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement DeductionsRoyaltyonPatents80RRB;
	...
	public EditVIADeductionsRoyaltyonPatents80RRB(WebDriver driver) {
		super(driver);
	...
	public void ClickDeductions() {
		DeductionsRoyaltyonPatents80RRB.click();
	}
