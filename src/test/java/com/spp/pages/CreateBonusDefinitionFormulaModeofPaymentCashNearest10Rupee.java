...
public class CreateBonusDefinitionFormulaModeofPaymentCashNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Diwali227')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	@FindBy(id="bonus_exgratia_definition_mode_of_payment")
	WebElement SelectModeofPayment;
	
	public CreateBonusDefinitionFormulaModeofPaymentCashNearest10Rupee(WebDriver driver) {
		super(driver);
