...
public class AddNewBonusDefinitionMaxBonusModeofPaymentBankAdvisePTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionMaxBonusModeofPaymentBankAdvisePTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
