...
public class CreateBonusDefinitionConsideremployeeswithminimumworkingFormulaPTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionConsideremployeeswithminimumworkingFormulaPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
