...
public class EditAllowancesTribalAreaScheduledAreaAgencyAreaAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[28]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement TribalAreaAllowanceGiven;
	...
	public EditAllowancesTribalAreaScheduledAreaAgencyAreaAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickTribalAreaAllowanceGiven() {
		TribalAreaAllowanceGiven.click();
	}
