...
public class CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentCash extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Eid12')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentCash(WebDriver driver) {
		super(driver);
