...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentCashCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentCashCurrentMonth(WebDriver driver) {
		super(driver);
