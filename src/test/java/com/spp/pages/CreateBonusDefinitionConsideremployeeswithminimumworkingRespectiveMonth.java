...
public class CreateBonusDefinitionConsideremployeeswithminimumworkingRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionConsideremployeeswithminimumworkingRespectiveMonth(WebDriver driver) {
		super(driver);
