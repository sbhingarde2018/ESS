...
public class EditAllowancesSnowBoundAreaOrAvalancheAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	public EditAllowancesSnowBoundAreaOrAvalancheAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickSnowAllowanceGiven() {
		SnowAllowanceGiven.click();
	}
