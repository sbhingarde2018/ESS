...
public class CreateBonusDefinitionConsideremployeeswithminimumworkingMaxBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionConsideremployeeswithminimumworkingMaxBonusRespectiveMonth(WebDriver driver) {
		super(driver);
