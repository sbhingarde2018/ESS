...
public class AddNewBonusDefinitionMaxBonusModeofPaymentCheque extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionMaxBonusModeofPaymentCheque(WebDriver driver) {
		super(driver);
