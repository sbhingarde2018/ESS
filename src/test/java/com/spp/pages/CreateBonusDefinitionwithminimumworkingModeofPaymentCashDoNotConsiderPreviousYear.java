...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentCashDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionwithminimumworkingModeofPaymentCashDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
