...
public class EditAllowancesDifficultAreaOrDisturbedAreaAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement DifficultAreaAllowanceGiven;
	...
	public EditAllowancesDifficultAreaOrDisturbedAreaAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickDifficultAreaAllowanceGiven() {
		DifficultAreaAllowanceGiven.click();
	}
