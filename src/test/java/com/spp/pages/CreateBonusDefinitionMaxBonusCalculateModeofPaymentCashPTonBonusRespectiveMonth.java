...
public class CreateBonusDefinitionMaxBonusCalculateModeofPaymentCashPTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusCalculateModeofPaymentCashPTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
