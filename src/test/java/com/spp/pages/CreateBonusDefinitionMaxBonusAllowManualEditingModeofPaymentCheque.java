...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentCheque extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri18')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentCheque(WebDriver driver) {
		super(driver);
