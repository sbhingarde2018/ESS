...
public class CreateADInterestamountNOIHigher1RupeeNoRecovery extends BasePage{
	@FindBy(id="salary")
	...
	public CreateADInterestamountNOIHigher1RupeeNoRecovery(WebDriver driver){
		super(driver);
	...
	public void clickHigher1Rupee() throws Exception{
		Higher1Rupee.click();
	}
