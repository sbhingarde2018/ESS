...
public class CreateBonusDefinitionFormulaCalculateModeofPaymentDDDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaCalculateModeofPaymentDDDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
