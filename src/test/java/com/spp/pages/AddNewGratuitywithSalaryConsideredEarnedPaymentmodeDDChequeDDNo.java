...
public class AddNewGratuitywithSalaryConsideredEarnedPaymentmodeDDChequeDDNo extends BasePage {
	@FindBy(id="salary")
	...
	public AddNewGratuitywithSalaryConsideredEarnedPaymentmodeDDChequeDDNo(WebDriver driver) {
		super(driver);
