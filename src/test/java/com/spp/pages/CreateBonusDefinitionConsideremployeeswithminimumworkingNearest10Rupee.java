...
public class CreateBonusDefinitionConsideremployeeswithminimumworkingNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionConsideremployeeswithminimumworkingNearest10Rupee(WebDriver driver) {
		super(driver);
