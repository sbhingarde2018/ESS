...
public class CreateArrearIndependentOfSalaryCashRestrictNegative extends BasePage{
	@FindBy(id="salary") 
...
public CreateArrearIndependentOfSalaryCashRestrictNegative(WebDriver driver) {
		super(driver);
