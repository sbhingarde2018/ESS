...
public class CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingModeofPaymentBankAdvise extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri15')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingModeofPaymentBankAdvise(WebDriver driver) {
		super(driver);
