...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentCash extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri2')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionwithminimumworkingModeofPaymentCash(WebDriver driver) {
		super(driver);
