...
public class AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeICICIBankLTD extends BasePage {
	@FindBy(id="salary")
	...
	public AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeICICIBankLTD(WebDriver driver) {
		super(driver);
