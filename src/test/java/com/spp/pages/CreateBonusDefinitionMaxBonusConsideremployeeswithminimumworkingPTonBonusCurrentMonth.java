...
public class CreateBonusDefinitionMaxBonusConsideremployeeswithminimumworkingPTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusConsideremployeeswithminimumworkingPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
