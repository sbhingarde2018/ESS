...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentCashRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentCashRespectiveMonth(WebDriver driver) {
		super(driver);
