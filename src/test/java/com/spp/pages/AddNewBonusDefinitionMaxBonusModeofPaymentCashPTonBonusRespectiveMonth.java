...
public class AddNewBonusDefinitionMaxBonusModeofPaymentCashPTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionMaxBonusModeofPaymentCashPTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
