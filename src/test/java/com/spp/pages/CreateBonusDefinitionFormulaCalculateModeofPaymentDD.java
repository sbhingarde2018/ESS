...
public class CreateBonusDefinitionFormulaCalculateModeofPaymentDD extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaCalculateModeofPaymentDD(WebDriver driver) {
		super(driver);
