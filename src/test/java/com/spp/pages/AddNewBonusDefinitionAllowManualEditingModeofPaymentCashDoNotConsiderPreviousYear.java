...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentCashDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentCashDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
