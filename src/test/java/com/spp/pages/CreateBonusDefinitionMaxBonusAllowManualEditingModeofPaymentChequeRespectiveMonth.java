...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentChequeRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentChequeRespectiveMonth(WebDriver driver) {
		super(driver);
