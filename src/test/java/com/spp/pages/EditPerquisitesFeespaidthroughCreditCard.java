...
public class EditPerquisitesFeespaidthroughCreditCard extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[108]/td[2]/a")
	WebElement FeesPaid;
	...
	public EditPerquisitesFeespaidthroughCreditCard(WebDriver driver) {
		super(driver);
