...
public class EditPerquisitesInterestfreeorconcessionalloans extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	public EditPerquisitesInterestfreeorconcessionalloans(WebDriver driver) {
		super(driver);
