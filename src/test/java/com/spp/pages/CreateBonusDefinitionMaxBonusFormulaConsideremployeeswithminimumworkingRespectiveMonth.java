...
public class CreateBonusDefinitionMaxBonusFormulaConsideremployeeswithminimumworkingRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusFormulaConsideremployeeswithminimumworkingRespectiveMonth(WebDriver driver) {
		super(driver);
