...
public class CreateArrearIndependentOfSalaryCashRestrictNegativePayPart extends BasePage{
	@FindBy(id="salary") 
	...
	@FindBy(id="arrear_salary_independent_component_0")
	WebElement Cash;
...
public CreateArrearIndependentOfSalaryCashRestrictNegativePayPart(WebDriver driver) {
		super(driver);
