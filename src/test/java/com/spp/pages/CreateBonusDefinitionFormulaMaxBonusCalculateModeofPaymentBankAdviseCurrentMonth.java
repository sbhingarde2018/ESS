...
public class CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentBankAdviseCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentBankAdviseCurrentMonth(WebDriver driver) {
		super(driver);
