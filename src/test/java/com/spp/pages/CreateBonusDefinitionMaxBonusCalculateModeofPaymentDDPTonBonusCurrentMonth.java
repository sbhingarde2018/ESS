...
public class CreateBonusDefinitionMaxBonusCalculateModeofPaymentDDPTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusCalculateModeofPaymentDDPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
