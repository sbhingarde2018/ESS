...
public class SelectLimitSnowBoundAreaOrAvalancheAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[47]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement SnowBoundAllowanceGiven;
	...
	public SelectLimitSnowBoundAreaOrAvalancheAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickSnowBoundAllowanceGiven() {
		SnowBoundAllowanceGiven.click();
	}
