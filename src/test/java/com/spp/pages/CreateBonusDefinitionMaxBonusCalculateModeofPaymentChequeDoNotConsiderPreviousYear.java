...
public class CreateBonusDefinitionMaxBonusCalculateModeofPaymentChequeDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusCalculateModeofPaymentChequeDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
