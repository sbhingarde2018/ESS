...
public class EditPerquisitesLeaveTravelConcession extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[13]/td[2]/a")
	WebElement LeaveTravelConcession;
	...
	public EditPerquisitesLeaveTravelConcession(WebDriver driver) {
		super(driver);
	...
	public void ClickLeaveTravelConcession() {
		LeaveTravelConcession.click();
	}
