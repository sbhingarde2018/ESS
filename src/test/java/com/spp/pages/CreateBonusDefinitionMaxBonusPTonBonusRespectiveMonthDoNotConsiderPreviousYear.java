...
public class CreateBonusDefinitionMaxBonusPTonBonusRespectiveMonthDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusPTonBonusRespectiveMonthDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
