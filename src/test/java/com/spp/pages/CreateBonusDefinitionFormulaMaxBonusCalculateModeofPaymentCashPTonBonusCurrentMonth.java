...
public class CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentCashPTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentCashPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
