...
public class EditPerquisitesPersonalAttendant extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[58]/td[3]/a")
	WebElement PersonalAttendants;
	...
	public EditPerquisitesPersonalAttendant(WebDriver driver) {
		super(driver);
	...
	public void ClickPersonalAttendants() {
		PersonalAttendants.click();
	}
