...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentCheque extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri17')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionwithminimumworkingModeofPaymentCheque(WebDriver driver) {
		super(driver);
