...
public class CreateBonusDefinitionModeofPaymentChequePTonBonusDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionModeofPaymentChequePTonBonusDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
