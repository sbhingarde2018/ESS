...
public class CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingCurrentMonth(WebDriver driver) {
		super(driver);
