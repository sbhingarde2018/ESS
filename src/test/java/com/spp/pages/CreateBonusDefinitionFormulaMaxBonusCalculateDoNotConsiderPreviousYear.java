...
public class CreateBonusDefinitionFormulaMaxBonusCalculateDoNotConsiderPreviousYear extends BasePage {
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculateDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
