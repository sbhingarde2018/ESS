...
public class CreateArrearBankAdviceRestrictNegativePayPart extends BasePage{
	@FindBy(id="salary") 
...
public CreateArrearBankAdviceRestrictNegativePayPart(WebDriver driver) {
		super(driver);
