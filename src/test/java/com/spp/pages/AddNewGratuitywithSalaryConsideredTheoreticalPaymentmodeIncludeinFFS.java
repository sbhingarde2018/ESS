...
public class AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeIncludeinFFS extends BasePage {
	@FindBy(id="salary")
	...
	public AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeIncludeinFFS(WebDriver driver) {
		super(driver);
