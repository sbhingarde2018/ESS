...
public class EditPerquisitesUseofmovableassetsbyemployees extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[118]/td[3]/a")
	WebElement MovableAssets;
	...
	public EditPerquisitesUseofmovableassetsbyemployees(WebDriver driver) {
		super(driver);
	...
	public void ClickMovableAssets() {
		MovableAssets.click();
	}
