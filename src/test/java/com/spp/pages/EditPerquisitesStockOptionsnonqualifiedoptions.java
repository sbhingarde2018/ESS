...
public class EditPerquisitesStockOptionsnonqualifiedoptions extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[128]/td[2]")
	WebElement StockOptions;
	...
	public EditPerquisitesStockOptionsnonqualifiedoptions(WebDriver driver) {
		super(driver);
