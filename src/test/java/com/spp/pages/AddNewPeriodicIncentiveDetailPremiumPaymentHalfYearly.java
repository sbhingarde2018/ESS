...
public class AddNewPeriodicIncentiveDetailPremiumPaymentHalfYearly extends BasePage{
	@FindBy(id="salary")
	...
	public AddNewPeriodicIncentiveDetailPremiumPaymentHalfYearly(WebDriver driver){
		super(driver);
