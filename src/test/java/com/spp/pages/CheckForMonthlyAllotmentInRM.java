...
public class CheckForMonthlyAllotmentInRM extends BasePage{
	public CheckForMonthlyAllotmentInRM(WebDriver driver) {
		super(driver);
	...
	@FindBy(xpath="//td[contains(text(),'Shanti')]/parent::tr/td[5]/input")
