...
public class CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentBankAdviseRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentBankAdviseRespectiveMonth(WebDriver driver) {
		super(driver);
