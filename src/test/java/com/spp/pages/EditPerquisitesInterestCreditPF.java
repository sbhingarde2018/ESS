...
public class EditPerquisitesInterestCreditPF extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[68]/td[2]/a")
	WebElement IntrestCredit;
	...
	public EditPerquisitesInterestCreditPF(WebDriver driver) {
		super(driver);
	...
	public void ClickIntrestCredit() {
		IntrestCredit.click();
	}
