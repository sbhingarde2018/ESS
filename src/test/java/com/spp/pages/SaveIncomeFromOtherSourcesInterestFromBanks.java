...
public class SaveIncomeFromOtherSourcesInterestFromBanks extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(id="income_from_other_sources_interest_from_banks_net_amount")
	WebElement NetAmount;
	@FindBy(id="income_from_other_sources_interest_from_banks_exemption")
	...
	public SaveIncomeFromOtherSourcesInterestFromBanks(WebDriver driver) {
		super(driver);
