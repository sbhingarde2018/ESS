...
public class AddNewBonusDefinitionMaxBonusModeofPaymentChequeDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionMaxBonusModeofPaymentChequeDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
