...
public class CheckifSalaryInsuranceGeneralLinksEmployeeMasterredirectstoEmployee extends BasePage{
	...
	public CheckifSalaryInsuranceGeneralLinksEmployeeMasterredirectstoEmployee(WebDriver driver) {
		super(driver);
