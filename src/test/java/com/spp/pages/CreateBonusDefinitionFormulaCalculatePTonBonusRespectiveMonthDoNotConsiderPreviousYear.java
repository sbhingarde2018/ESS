...
public class CreateBonusDefinitionFormulaCalculatePTonBonusRespectiveMonthDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaCalculatePTonBonusRespectiveMonthDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
