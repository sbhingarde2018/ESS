...
public class EditPerquisitesWatchman extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[53]/td[3]/a")
	WebElement Watchman;
	...
	public EditPerquisitesWatchman(WebDriver driver) {
		super(driver);
