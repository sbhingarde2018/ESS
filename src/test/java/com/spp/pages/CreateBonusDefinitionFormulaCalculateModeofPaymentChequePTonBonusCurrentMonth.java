...
public class CreateBonusDefinitionFormulaCalculateModeofPaymentChequePTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaCalculateModeofPaymentChequePTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
