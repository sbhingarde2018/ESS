...
public class EditAllowancesSpecialCompensatoryHillyAreaAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[32]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement HillyareaAllowanceGiven;
	...
	public EditAllowancesSpecialCompensatoryHillyAreaAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickHillyareaAllowanceGiven() {
		HillyareaAllowanceGiven.click();
	}
