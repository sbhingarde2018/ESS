...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentBankAdviseCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentBankAdviseCurrentMonth(WebDriver driver) {
		super(driver);
