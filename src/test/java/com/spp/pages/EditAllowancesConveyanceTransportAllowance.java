...
public class EditAllowancesConveyanceTransportAllowance extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(id="Allowance Given")
	WebElement AlLowanceGiven;
	...
	public EditAllowancesConveyanceTransportAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickAllowanceGiven() {
		AlLowanceGiven.click();
	}
