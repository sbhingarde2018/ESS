...
public class CreateBonusDefinitionMaxBonusFormulaPTonBonusRespectiveMonthDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusFormulaPTonBonusRespectiveMonthDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
