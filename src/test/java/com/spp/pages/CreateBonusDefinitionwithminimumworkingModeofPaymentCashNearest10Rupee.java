...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentCashNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Diwali230')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	@FindBy(id="bonus_exgratia_definition_mode_of_payment")
	WebElement SelectModeofPayment;
	
	public CreateBonusDefinitionwithminimumworkingModeofPaymentCashNearest10Rupee(WebDriver driver) {
		super(driver);
