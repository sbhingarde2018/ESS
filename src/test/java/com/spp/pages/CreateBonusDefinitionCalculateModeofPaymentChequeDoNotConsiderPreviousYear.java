...
public class CreateBonusDefinitionCalculateModeofPaymentChequeDoNotConsiderPreviousYear extends BasePage{
	...
	public CreateBonusDefinitionCalculateModeofPaymentChequeDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
