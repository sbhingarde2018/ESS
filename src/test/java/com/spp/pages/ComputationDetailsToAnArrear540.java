...
public class ComputationDetailsToAnArrear540 extends BasePage {
	@FindBy(id="salary") 
	WebElement SalaryLink;
	@FindBy(xpath="//div[@class='dropdown_5columns salaries']//a[contains(text(),'Arrears')]")
	WebElement Arrears;
	@FindBy(xpath="//table/tbody/tr/td[contains(text(),'Arreartest2')]/parent::tr/td[4]/a")
	...
	public ComputationDetailsToAnArrear540(WebDriver driver) {
			super(driver);
