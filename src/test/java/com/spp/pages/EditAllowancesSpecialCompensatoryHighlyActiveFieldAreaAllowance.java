...
public class EditAllowancesSpecialCompensatoryHighlyActiveFieldAreaAllowance extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[78]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement SpclCompensatoryAllowanceGiven;
	...
	public EditAllowancesSpecialCompensatoryHighlyActiveFieldAreaAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickSpclCompensatoryAllowanceGiven() {
		SpclCompensatoryAllowanceGiven.click();
	}
