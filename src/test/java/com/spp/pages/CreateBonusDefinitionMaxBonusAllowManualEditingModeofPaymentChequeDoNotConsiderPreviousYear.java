...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentChequeDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentChequeDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
