...
public class CreateBonusDefinitionMaxBonusAllowManualEditingRespectiveMonthDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusAllowManualEditingRespectiveMonthDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
