...
public class AddNewBonusDefinitionFormulaModeofPaymentBankAdviseDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionFormulaModeofPaymentBankAdviseDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
