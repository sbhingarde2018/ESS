...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentCash extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri1')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentCash(WebDriver driver) {
		super(driver);
