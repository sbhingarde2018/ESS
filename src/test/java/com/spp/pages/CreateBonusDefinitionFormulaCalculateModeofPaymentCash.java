...
public class CreateBonusDefinitionFormulaCalculateModeofPaymentCash extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Eid13')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionFormulaCalculateModeofPaymentCash(WebDriver driver) {
		super(driver);
