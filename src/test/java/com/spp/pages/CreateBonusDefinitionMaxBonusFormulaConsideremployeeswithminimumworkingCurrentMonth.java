...
public class CreateBonusDefinitionMaxBonusFormulaConsideremployeeswithminimumworkingCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusFormulaConsideremployeeswithminimumworkingCurrentMonth(WebDriver driver) {
		super(driver);
