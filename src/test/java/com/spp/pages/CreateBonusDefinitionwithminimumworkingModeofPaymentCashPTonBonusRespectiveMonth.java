...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentCashPTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionwithminimumworkingModeofPaymentCashPTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
