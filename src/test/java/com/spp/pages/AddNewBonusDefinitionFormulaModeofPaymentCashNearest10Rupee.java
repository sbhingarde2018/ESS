...
public class AddNewBonusDefinitionFormulaModeofPaymentCashNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Diwali222')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public AddNewBonusDefinitionFormulaModeofPaymentCashNearest10Rupee(WebDriver driver) {
		super(driver);
