...
public class CreateBonusDefinitionMaxBonusCalculateModeofPaymentCashNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusCalculateModeofPaymentCashNearest10Rupee(WebDriver driver) {
		super(driver);
