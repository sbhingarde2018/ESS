...
public class EditOthersAmountReceivedOnVoluntaryRetirement extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement Others;
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[39]/td[2]/a")
	WebElement AmountReceivedOnVoluntaryRetirement;
	...
	public EditOthersAmountReceivedOnVoluntaryRetirement(WebDriver driver) {
		super(driver);
	...
	public void ClickAmountReceivedOnVoluntaryRetirement() {
		AmountReceivedOnVoluntaryRetirement.click();
	}
