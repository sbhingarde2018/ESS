...
public class CheckifEmployeeManualLeaveAllotmentGeneralLinkredirectstoEmployeeMaster extends BasePage{
	...
	public void clickonmanualleaveallot() {
		ClickOnManualLeaveAllot.click();
	}
