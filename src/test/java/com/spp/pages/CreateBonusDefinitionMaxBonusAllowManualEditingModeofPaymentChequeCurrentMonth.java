...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentChequeCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentChequeCurrentMonth(WebDriver driver) {
		super(driver);
