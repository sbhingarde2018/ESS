...
public class EditSalaryGroupRoundOffNearestRupee extends BasePage {
	@FindBy(id="master")
	WebElement masterlink;
	@FindBy(xpath="//a[text()='Salary Structure']")
	WebElement salarystructurelink;
	@FindBy(xpath="//table/tbody/tr/td[contains(text(),'GS_L')]/parent::tr/td[3]/a")
	...
	public EditSalaryGroupRoundOffNearestRupee(WebDriver driver){
		super(driver);
