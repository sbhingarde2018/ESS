...
public class EditPerquisitesTaxPaidByEmployer extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[73]/td[2]/a")
	WebElement TaxPaidByEmp;
	...
	public EditPerquisitesTaxPaidByEmployer(WebDriver driver) {
		super(driver);
