...
public class EditPerquisitesRentFreeAccommodation extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[3]/td[3]/a")
	WebElement RentFreeAcc;
	...
	public EditPerquisitesRentFreeAccommodation(WebDriver driver) {
		super(driver);
