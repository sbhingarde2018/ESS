...
public class CheckifSalaryLoanGeneralLinksEmployeeMasterredirectstoEmployee extends BasePage{
	@FindBy(id="salary")
	...
	public CheckifSalaryLoanGeneralLinksEmployeeMasterredirectstoEmployee(WebDriver driver) {
		super(driver);
