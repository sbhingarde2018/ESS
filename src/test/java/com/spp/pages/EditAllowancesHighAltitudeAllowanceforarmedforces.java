...
public class EditAllowancesHighAltitudeAllowanceforarmedforces extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[82]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement HighALtitudeArmedAllowanceGiven;
	...
	public EditAllowancesHighAltitudeAllowanceforarmedforces(WebDriver driver) {
		super(driver);
	...
	public void ClickHighALtitudeArmedAllowanceGiven() {
		HighALtitudeArmedAllowanceGiven.click();
	}
