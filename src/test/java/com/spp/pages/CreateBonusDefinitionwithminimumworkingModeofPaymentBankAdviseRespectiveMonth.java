...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentBankAdviseRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionwithminimumworkingModeofPaymentBankAdviseRespectiveMonth(WebDriver driver) {
		super(driver);
