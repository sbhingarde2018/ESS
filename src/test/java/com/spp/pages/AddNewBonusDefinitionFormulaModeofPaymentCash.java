...
public class AddNewBonusDefinitionFormulaModeofPaymentCash extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Eid10')]/parent::tr/td[4]/a/img")
