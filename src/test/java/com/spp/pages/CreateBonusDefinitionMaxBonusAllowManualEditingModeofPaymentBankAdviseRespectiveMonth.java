...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentBankAdviseRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentBankAdviseRespectiveMonth(WebDriver driver) {
		super(driver);
