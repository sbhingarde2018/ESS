...
public class EditPerquisitesCarOtherAutomotive extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[83]/td[3]/a")
	WebElement CarOtherAutoMotive;
	...
	public EditPerquisitesCarOtherAutomotive(WebDriver driver) {
		super(driver);
	...
	public void ClickCarOtherAutoMotive() {
		CarOtherAutoMotive.click();
	}
