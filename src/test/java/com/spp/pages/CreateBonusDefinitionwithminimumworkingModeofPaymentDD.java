...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentDD extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionwithminimumworkingModeofPaymentDD(WebDriver driver) {
		super(driver);
