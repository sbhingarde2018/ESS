...
public class CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingModeofPaymentDD extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingModeofPaymentDD(WebDriver driver) {
		super(driver);
