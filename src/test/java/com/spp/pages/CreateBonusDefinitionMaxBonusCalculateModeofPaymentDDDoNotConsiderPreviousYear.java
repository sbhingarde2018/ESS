...
public class CreateBonusDefinitionMaxBonusCalculateModeofPaymentDDDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusCalculateModeofPaymentDDDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
