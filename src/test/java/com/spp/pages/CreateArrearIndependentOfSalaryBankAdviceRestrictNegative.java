...
public class CreateArrearIndependentOfSalaryBankAdviceRestrictNegative extends BasePage{
	@FindBy(id="salary") 
...
public CreateArrearIndependentOfSalaryBankAdviceRestrictNegative(WebDriver driver) {
		super(driver);
