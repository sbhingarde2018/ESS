...
public class EditOthersAmountReceivedFromUnrecognizedProvidentFund extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement Others;
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[21]/td[2]/a")
	WebElement AmtRecFromUnrecognixedPF;
	...
	public EditOthersAmountReceivedFromUnrecognizedProvidentFund(WebDriver driver) {
		super(driver);
	...
	public void ClickAmtRecFromUnrecognixedPF() {
		AmtRecFromUnrecognixedPF.click();
	}
