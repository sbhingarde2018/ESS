...
public class CreateBonusDefinitionMaxBonusCalculateDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusCalculateDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
