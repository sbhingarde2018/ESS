...
public class CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentDDDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentDDDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
