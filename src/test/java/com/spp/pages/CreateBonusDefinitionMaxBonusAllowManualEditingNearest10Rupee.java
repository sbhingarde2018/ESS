...
public class CreateBonusDefinitionMaxBonusAllowManualEditingNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusAllowManualEditingNearest10Rupee(WebDriver driver) {
		super(driver);
