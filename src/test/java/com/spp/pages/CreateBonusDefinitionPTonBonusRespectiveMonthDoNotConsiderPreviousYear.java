...
public class CreateBonusDefinitionPTonBonusRespectiveMonthDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionPTonBonusRespectiveMonthDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
