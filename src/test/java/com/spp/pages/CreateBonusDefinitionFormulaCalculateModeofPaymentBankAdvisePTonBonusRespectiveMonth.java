...
public class CreateBonusDefinitionFormulaCalculateModeofPaymentBankAdvisePTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//*[@id=\"bonus_or_exgratia\"]/div/table/tbody/tr/td[contains(text(),'Diwali1')]/parent::tr/td[4]/a")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionFormulaCalculateModeofPaymentBankAdvisePTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
	...
	public void selectrespectivemonthandpreviousyear() {
