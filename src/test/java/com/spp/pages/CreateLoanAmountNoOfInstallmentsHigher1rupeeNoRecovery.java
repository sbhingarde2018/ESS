...
public class CreateLoanAmountNoOfInstallmentsHigher1rupeeNoRecovery extends BasePage{
	@FindBy(id="salary")
	...
	@FindBy(id="standing_instruction_detail_round_off_1")
	WebElement RoundoffHighestRupee;
...
public CreateLoanAmountNoOfInstallmentsHigher1rupeeNoRecovery(WebDriver driver) {
	super(driver);
...
public void enternoofinstallments(String value) {
