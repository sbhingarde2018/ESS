...
public class EditVIADeductionsMedicalinsurancepremiumpaid80DForparents extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	public EditVIADeductionsMedicalinsurancepremiumpaid80DForparents(WebDriver driver) {
		super(driver);
