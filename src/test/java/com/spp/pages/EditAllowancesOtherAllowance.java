...
public class EditAllowancesOtherAllowance extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement otherAllowanceGiven;
	...
	public EditAllowancesOtherAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickotherAllowanceGiven() {
		otherAllowanceGiven.click();
	}
