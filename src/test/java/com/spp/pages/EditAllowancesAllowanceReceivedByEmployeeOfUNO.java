...
public class EditAllowancesAllowanceReceivedByEmployeeOfUNO extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[107]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement EmpUNOAllowanceGiven;
	...
	public EditAllowancesAllowanceReceivedByEmployeeOfUNO(WebDriver driver) {
		super(driver);
	...
	public void ClickEmpUNOAllowanceGiven() {
		EmpUNOAllowanceGiven.click();
	}
