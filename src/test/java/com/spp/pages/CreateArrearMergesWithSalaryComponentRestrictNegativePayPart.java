...
public class CreateArrearMergesWithSalaryComponentRestrictNegativePayPart extends BasePage{
...
public CreateArrearMergesWithSalaryComponentRestrictNegativePayPart(WebDriver driver) {
		super(driver);
