...
public class AddNewBonusDefinitionMaxBonusModeofPaymentCashPTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionMaxBonusModeofPaymentCashPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
