...
public class EditAllowancesCounterInsurgencyAllowanceGrantedToMembersofArmedForces extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[70]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement CounterInsurgencyAllowanceGiven;
	...
	public EditAllowancesCounterInsurgencyAllowanceGrantedToMembersofArmedForces(WebDriver driver) {
		super(driver);
	...
	public void ClickCounterInsurgencyAllowanceGiven() {
		CounterInsurgencyAllowanceGiven.click();
	}
