...
public class EditMainComponentBasic extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"main_components_list\"]/table/tbody/tr/td[contains(text(),'Basic')]/parent::tr/td[2]/a")
	...
	public EditMainComponentBasic(WebDriver driver) {
		super(driver);
