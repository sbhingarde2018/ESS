...
public class EditCompanydetailsValidation extends BasePage {
	@FindBy(id="master")
	...
	@FindBy(id="company_companyname-error")
	WebElement companynamevalidation;
	@FindBy(id="company_dateofestablishment-error")
	WebElement estblisheddatevalidation;
	@FindBy(id="company_responsible_person-error")
	WebElement responsepersonvalidation;
	@FindBy(id="company_phonenumber1-error")
	WebElement phonenovalidation;
	@FindBy(id="company_address-error")
	WebElement address1validation;
	@FindBy(id="company_email-error")
	WebElement Emailvalidation;
	@FindBy(id="company_photo")
	WebElement companylogo;
	@FindBy(xpath="//div[@class=\"alert alert-danger\"]//li[2]")
	WebElement logoinvalid;
	public EditCompanydetailsValidation(WebDriver driver){
	    super(driver);
	...
	public String getMessageResopnseperson(){
		return responsepersonvalidation.getText();
	}
	
	public String getMessageEstablishdate(){
		return estblisheddatevalidation.getText();
	}
	public String getMessagePhoneno(){
		return phonenovalidation.getText();
	}
	public String getMessageAddress(){
		return address1validation.getText();
	}
	
	public String getMessageEmail(){
		return Emailvalidation.getText();
	}
	public void companylogo(String value) throws Exception{

		companylogo.sendKeys(value);
	}
	public String getMessageinvalidlogo(){
		return logoinvalid.getText();
	}
