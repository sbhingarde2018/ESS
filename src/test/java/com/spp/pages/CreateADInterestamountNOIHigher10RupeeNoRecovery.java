...
public class CreateADInterestamountNOIHigher10RupeeNoRecovery extends BasePage{
	@FindBy(id="salary")
	...
	public CreateADInterestamountNOIHigher10RupeeNoRecovery(WebDriver driver){
		super(driver);
