...
public class CreateBonusDefinitionMaxBonusConsideremployeeswithminimumworkingModeofPaymentDD extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusConsideremployeeswithminimumworkingModeofPaymentDD(WebDriver driver) {
		super(driver);
