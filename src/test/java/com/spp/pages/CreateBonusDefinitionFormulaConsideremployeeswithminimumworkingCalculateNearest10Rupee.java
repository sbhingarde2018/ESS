...
public class CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingCalculateNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingCalculateNearest10Rupee(WebDriver driver) {
		super(driver);
