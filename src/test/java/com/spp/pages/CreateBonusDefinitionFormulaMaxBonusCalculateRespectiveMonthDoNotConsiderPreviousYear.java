...
public class CreateBonusDefinitionFormulaMaxBonusCalculateRespectiveMonthDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculateRespectiveMonthDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
