...
public class CreateBonusDefinitionFormulaMaxBonusCalculatePTonBonusDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculatePTonBonusDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
