...
public class EditOthersRetrenchmentCompensation extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement RetrenchmentCompensation;
	...
	public EditOthersRetrenchmentCompensation(WebDriver driver) {
		super(driver);
	...
	public void ClickRetrenchmentCompensation() {
		RetrenchmentCompensation.click();
	}
