...
public class SelectLimitHighAltitudeAllowanceforarmedforces extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement ArmedForcesAllowanceGiven;
	...
	public SelectLimitHighAltitudeAllowanceforarmedforces(WebDriver driver) {
		super(driver);
	...
	public void ClickArmedForcesAllowanceGiven() {
		ArmedForcesAllowanceGiven.click();
	}
