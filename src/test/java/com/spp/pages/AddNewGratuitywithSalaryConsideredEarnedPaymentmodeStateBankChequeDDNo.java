...
public class AddNewGratuitywithSalaryConsideredEarnedPaymentmodeStateBankChequeDDNo extends BasePage {
	@FindBy(id="salary")
	...
	public AddNewGratuitywithSalaryConsideredEarnedPaymentmodeStateBankChequeDDNo(WebDriver driver) {
		super(driver);
