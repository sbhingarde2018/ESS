...
public class EditPerquisitesGardener extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[48]/td[3]/a")
	WebElement Gardener;
	...
	public EditPerquisitesGardener(WebDriver driver) {
		super(driver);
