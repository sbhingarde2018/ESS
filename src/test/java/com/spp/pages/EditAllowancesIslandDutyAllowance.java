...
public class EditAllowancesIslandDutyAllowance extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[87]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement IslandAllowanceGiven;
	...
	public EditAllowancesIslandDutyAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickIslandAllowanceGiven() {
		IslandAllowanceGiven.click();
	}
