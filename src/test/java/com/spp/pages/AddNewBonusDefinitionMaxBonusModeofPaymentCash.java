...
public class AddNewBonusDefinitionMaxBonusModeofPaymentCash extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri4')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	public AddNewBonusDefinitionMaxBonusModeofPaymentCash(WebDriver driver) {
		super(driver);
