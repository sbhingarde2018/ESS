...
public class AddNewBonusDefinitionFormulaModeofPaymentDDPTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionFormulaModeofPaymentDDPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
