...
public class EditnameOTHERSUserDefined extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement Others;
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[54]/td[1]/table/tbody/tr/th[2]/a")
	WebElement EditName;
	...
	public EditnameOTHERSUserDefined(WebDriver driver) {
		super(driver);
