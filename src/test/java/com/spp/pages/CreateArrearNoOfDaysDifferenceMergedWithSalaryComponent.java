...
public class CreateArrearNoOfDaysDifferenceMergedWithSalaryComponent extends BasePage{
	@FindBy(id="salary") 
...
public CreateArrearNoOfDaysDifferenceMergedWithSalaryComponent(WebDriver driver) {
		super(driver);
