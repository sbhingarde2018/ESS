...
public class CreateBonusDefinitionMaxBonusCalculateModeofPaymentChequePTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusCalculateModeofPaymentChequePTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
