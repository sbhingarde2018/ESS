...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentBankAdviseRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentBankAdviseRespectiveMonth(WebDriver driver) {
		super(driver);
