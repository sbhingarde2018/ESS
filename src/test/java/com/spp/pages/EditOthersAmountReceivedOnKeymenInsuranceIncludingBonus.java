...
public class EditOthersAmountReceivedOnKeymenInsuranceIncludingBonus extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement Others;
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[25]/td[2]/a")
	WebElement AmountReceivedOnKeymenInsurance;
	...
	public EditOthersAmountReceivedOnKeymenInsuranceIncludingBonus(WebDriver driver) {
		super(driver);
	...
	public void ClickAmountReceivedOnKeymenInsurance() {
		AmountReceivedOnKeymenInsurance.click();
	}
