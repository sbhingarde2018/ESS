...
public class CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentChequeCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentChequeCurrentMonth(WebDriver driver) {
		super(driver);
