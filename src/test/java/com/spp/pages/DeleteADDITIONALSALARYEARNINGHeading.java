...
public class DeleteADDITIONALSALARYEARNINGHeading extends BasePage{
	@FindBy(id="salary")
	...
	@FindBy(xpath="//div[2]/table/tbody/tr/td[contains(text(),'Bonus Gift44')]/parent::tr/td[6]/a")
	...
	public DeleteADDITIONALSALARYEARNINGHeading(WebDriver driver) {
		super(driver);
