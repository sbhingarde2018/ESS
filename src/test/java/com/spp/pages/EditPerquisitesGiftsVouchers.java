...
public class EditPerquisitesGiftsVouchers extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[103]/td[2]/a")
	...
	public EditPerquisitesGiftsVouchers(WebDriver driver) {
		super(driver);
