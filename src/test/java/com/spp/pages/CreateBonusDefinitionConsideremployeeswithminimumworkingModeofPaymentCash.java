...
public class CreateBonusDefinitionConsideremployeeswithminimumworkingModeofPaymentCash extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri999')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionConsideremployeeswithminimumworkingModeofPaymentCash(WebDriver driver) {
		super(driver);
