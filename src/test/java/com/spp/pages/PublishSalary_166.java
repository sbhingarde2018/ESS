...
public class PublishSalary_166 extends BasePage{

	public PublishSalary_166(WebDriver driver) {
		super(driver);
	...
	public void selectPublishSalaryStructure(String value){
		dropDownSelect(PublishSalaryStructure, value);
	}
	...
	public void EnterUnit(String value) throws Exception{
		Unit.sendKeys(value);
	}
}