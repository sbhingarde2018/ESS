...
public class CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentDDPTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentDDPTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
