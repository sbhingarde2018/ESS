...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentDDPTonBonusCurrentMonth extends BasePage{
	...
	public CreateBonusDefinitionwithminimumworkingModeofPaymentDDPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
