...
public class UpdateReimbursementMstrbyConsideringRestrictClaimAmt extends BasePage{
	@FindBy(id="master")
	...
	@FindBy(id="reimbursement_master_based_on_doj_dol")
	WebElement SelectConsiderSal;
	@FindBy(id="reimbursement_master_restrict_till_date")
	WebElement RestrictClaimAmt;
	...
	public void considersal() {
		SelectConsiderSal.click();
	}
	public void selectrestrictclaimamt() {
		RestrictClaimAmt.click();
	}
