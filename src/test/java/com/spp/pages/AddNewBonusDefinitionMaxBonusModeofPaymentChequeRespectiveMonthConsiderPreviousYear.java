...
public class AddNewBonusDefinitionMaxBonusModeofPaymentChequeRespectiveMonthConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionMaxBonusModeofPaymentChequeRespectiveMonthConsiderPreviousYear(WebDriver driver) {
		super(driver);
