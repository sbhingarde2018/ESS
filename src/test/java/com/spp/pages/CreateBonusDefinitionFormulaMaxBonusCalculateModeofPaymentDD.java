...
public class CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentDD extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentDD(WebDriver driver) {
		super(driver);
