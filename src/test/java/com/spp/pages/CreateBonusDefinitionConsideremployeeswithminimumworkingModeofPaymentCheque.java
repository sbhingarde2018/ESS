...
public class CreateBonusDefinitionConsideremployeeswithminimumworkingModeofPaymentCheque extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionConsideremployeeswithminimumworkingModeofPaymentCheque(WebDriver driver) {
		super(driver);
