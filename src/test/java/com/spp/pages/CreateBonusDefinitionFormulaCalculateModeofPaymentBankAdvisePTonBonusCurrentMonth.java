...
public class CreateBonusDefinitionFormulaCalculateModeofPaymentBankAdvisePTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaCalculateModeofPaymentBankAdvisePTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
