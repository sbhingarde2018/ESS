...
public class CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingModeofPaymentCash extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Eid15')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingModeofPaymentCash(WebDriver driver) {
		super(driver);
