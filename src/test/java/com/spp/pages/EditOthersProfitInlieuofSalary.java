...
public class EditOthersProfitInlieuofSalary extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement Others;
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[7]/td[2]/a")
	WebElement ProfitInLieu;
	...
	public EditOthersProfitInlieuofSalary(WebDriver driver) {
		super(driver);
