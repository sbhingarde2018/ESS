...
public class CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingPTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
