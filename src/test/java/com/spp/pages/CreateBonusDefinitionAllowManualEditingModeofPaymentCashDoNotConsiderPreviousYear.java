...
public class CreateBonusDefinitionAllowManualEditingModeofPaymentCashDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionAllowManualEditingModeofPaymentCashDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
