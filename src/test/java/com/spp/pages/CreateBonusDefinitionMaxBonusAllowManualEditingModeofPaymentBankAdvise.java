...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentBankAdvise extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri11')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentBankAdvise(WebDriver driver) {
		super(driver);
