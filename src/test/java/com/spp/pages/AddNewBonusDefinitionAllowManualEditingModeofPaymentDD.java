...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentDD extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentDD(WebDriver driver) {
		super(driver);
