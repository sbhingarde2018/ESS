...
public class CreateBonusDefinitionModeofPaymentBankAdvisePTonBonusDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionModeofPaymentBankAdvisePTonBonusDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
