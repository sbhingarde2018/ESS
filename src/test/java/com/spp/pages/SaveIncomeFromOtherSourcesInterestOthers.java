...
public class SaveIncomeFromOtherSourcesInterestOthers extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(id="income_from_other_sources_interest_others_net_amount")
	WebElement NetAmount;
	@FindBy(id="income_from_other_sources_interest_others_exemption")
	...
	public SaveIncomeFromOtherSourcesInterestOthers(WebDriver driver) {
		super(driver);
