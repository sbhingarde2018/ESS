...
public class CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingModeofPaymentCheque extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingModeofPaymentCheque(WebDriver driver) {
		super(driver);
