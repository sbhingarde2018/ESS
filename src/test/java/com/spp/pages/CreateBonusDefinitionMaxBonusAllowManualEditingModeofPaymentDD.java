...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentDD extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentDD(WebDriver driver) {
		super(driver);
