...
public class CreateBonusDefinitionModeofPaymentBankAdvisePTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionModeofPaymentBankAdvisePTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
