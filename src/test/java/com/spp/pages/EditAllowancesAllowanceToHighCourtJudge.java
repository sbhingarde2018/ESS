...
public class EditAllowancesAllowanceToHighCourtJudge extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[99]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement HighcourtAllowanceGiven;
	...
	public EditAllowancesAllowanceToHighCourtJudge(WebDriver driver) {
		super(driver);
	...
	public void ClickHighcourtAllowanceGiven() {
		HighcourtAllowanceGiven.click();
	}
