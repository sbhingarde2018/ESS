...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentBankAdvisePTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionwithminimumworkingModeofPaymentBankAdvisePTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
