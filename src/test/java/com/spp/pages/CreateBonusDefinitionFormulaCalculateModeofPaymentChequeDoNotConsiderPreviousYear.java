...
public class CreateBonusDefinitionFormulaCalculateModeofPaymentChequeDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaCalculateModeofPaymentChequeDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
