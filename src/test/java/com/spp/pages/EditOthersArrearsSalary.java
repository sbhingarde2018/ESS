...
public class EditOthersArrearsSalary extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement Others;
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[23]/td[2]/a")
	WebElement ArrearsSalary;
	...
	public EditOthersArrearsSalary(WebDriver driver) {
		super(driver);
	...
	public void ClickArrearsSalary() {
		ArrearsSalary.click();
	}
