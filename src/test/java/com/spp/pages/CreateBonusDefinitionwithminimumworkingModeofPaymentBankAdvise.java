...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentBankAdvise extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri9')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionwithminimumworkingModeofPaymentBankAdvise(WebDriver driver) {
		super(driver);
