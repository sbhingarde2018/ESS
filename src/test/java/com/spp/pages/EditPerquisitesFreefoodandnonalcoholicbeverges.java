...
public class EditPerquisitesFreefoodandnonalcoholicbeverges extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[93]/td[2]/a")
	WebElement FreeFood;
	...
	public EditPerquisitesFreefoodandnonalcoholicbeverges(WebDriver driver) {
		super(driver);
