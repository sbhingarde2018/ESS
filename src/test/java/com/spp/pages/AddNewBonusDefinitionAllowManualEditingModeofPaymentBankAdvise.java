...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentBankAdvise extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri8')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentBankAdvise(WebDriver driver) {
		super(driver);
