...
public class CreateBonusDefinitionFormulaConsideremployeeswithminimumworking extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaConsideremployeeswithminimumworking(WebDriver driver) {
		super(driver);
