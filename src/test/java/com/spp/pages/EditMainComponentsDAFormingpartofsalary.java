...
public class EditMainComponentsDAFormingpartofsalary extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	public EditMainComponentsDAFormingpartofsalary(WebDriver driver) {
		super(driver);
	...
	public void ClickDAFormingEdit() {
		BasicEdit.click();
	}
