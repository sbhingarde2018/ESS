...
public class AddNewBonusDefinitionMaxBonusModeofPaymentBankAdvisePTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionMaxBonusModeofPaymentBankAdvisePTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
