...
public class CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingRespectiveMonth(WebDriver driver) {
		super(driver);
