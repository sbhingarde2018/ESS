...
public class EditMainComponentsCommisionasaofturnover extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"main_components_list\"]/table/tbody/tr/td[contains(text(),'Commision as a % of turnover')]/parent::tr/td[2]/a")
...
public EditMainComponentsCommisionasaofturnover(WebDriver driver) {
		super(driver);
	...
	public void ClickCommisionEdit() {
		BasicEdit.click();
	}
