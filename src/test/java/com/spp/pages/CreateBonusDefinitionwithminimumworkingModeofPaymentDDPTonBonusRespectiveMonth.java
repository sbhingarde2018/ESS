...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentDDPTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionwithminimumworkingModeofPaymentDDPTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
