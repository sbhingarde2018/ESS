...
public class CreateBonusDefinitionFormulaCalculateModeofPaymentDDPTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaCalculateModeofPaymentDDPTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
