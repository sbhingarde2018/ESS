...
public class CreateArrearAsSalaryComponentRestrictNegativePayPart extends BasePage{
	@FindBy(id="salary") 
...
public CreateArrearAsSalaryComponentRestrictNegativePayPart(WebDriver driver) {
		super(driver);
