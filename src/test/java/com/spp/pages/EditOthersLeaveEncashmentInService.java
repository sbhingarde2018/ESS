...
public class EditOthersLeaveEncashmentInService extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement LeaveEncashmentInService;
	...
	public EditOthersLeaveEncashmentInService(WebDriver driver) {
		super(driver);
	...
	public void ClickLeaveEncashmentInService() {
		LeaveEncashmentInService.click();
	}
