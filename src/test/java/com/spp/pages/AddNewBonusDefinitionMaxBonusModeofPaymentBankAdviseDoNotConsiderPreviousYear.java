...
public class AddNewBonusDefinitionMaxBonusModeofPaymentBankAdviseDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionMaxBonusModeofPaymentBankAdviseDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
