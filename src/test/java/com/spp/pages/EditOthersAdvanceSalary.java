...
public class EditOthersAdvanceSalary extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement Others;
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[11]/td[2]/a")
	WebElement AdvanceSalary;
	...
	public EditOthersAdvanceSalary(WebDriver driver) {
		super(driver);
	...
	public void ClickAdvanceSalary() {
		AdvanceSalary.click();
	}
