...
public class CreateBonusDefinitionMaxBonusCalculateModeofPaymentCash extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Eid14')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionMaxBonusCalculateModeofPaymentCash(WebDriver driver) {
		super(driver);
