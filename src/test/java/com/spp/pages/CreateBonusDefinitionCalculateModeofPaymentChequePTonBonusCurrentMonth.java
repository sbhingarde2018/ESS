...
public class CreateBonusDefinitionCalculateModeofPaymentChequePTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionCalculateModeofPaymentChequePTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
