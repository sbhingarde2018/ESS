...
public class CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentBankAdvise extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri10')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentBankAdvise(WebDriver driver) {
		super(driver);
