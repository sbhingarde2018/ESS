...
public class PopulateandCreateLetOutProperty extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	public PopulateandCreateLetOutProperty(WebDriver driver) {
		super(driver);
	...
	public void ClickPopulateAndCreate() {
		PopulateAndCreate.click();
	}
