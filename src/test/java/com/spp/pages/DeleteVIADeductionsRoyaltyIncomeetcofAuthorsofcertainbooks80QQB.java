...
public class DeleteVIADeductionsRoyaltyIncomeetcofAuthorsofcertainbooks80QQB extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	public DeleteVIADeductionsRoyaltyIncomeetcofAuthorsofcertainbooks80QQB(WebDriver driver) {
		super(driver);
