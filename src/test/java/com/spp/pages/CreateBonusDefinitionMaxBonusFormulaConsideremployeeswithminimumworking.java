...
public class CreateBonusDefinitionMaxBonusFormulaConsideremployeeswithminimumworking  extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusFormulaConsideremployeeswithminimumworking(WebDriver driver) {
		super(driver);
