...
public class AddNewBonusDefinitionFormulaModeofPaymentChequePTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionFormulaModeofPaymentChequePTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
