...
public class AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeDDChequeDDNoChequeDDdate extends BasePage {
	@FindBy(id="salary")
	...
	public AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeDDChequeDDNoChequeDDdate(WebDriver driver) {
		super(driver);
