...
public class EditAllowancesCompensatoryModifiedFieldAreaAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[66]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement ModifiedCompensatoryAllowanceGiven;
	...
	public EditAllowancesCompensatoryModifiedFieldAreaAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickModifiedCompensatoryAllowanceGiven() {
		ModifiedCompensatoryAllowanceGiven.click();
	}
