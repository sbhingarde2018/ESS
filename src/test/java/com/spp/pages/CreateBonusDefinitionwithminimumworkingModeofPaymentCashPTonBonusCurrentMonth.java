...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentCashPTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionwithminimumworkingModeofPaymentCashPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
