...
public class EditAllowancesAllowanceforTransportEmployees extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[24]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement TransportAllowanceGiven;
	...
	public EditAllowancesAllowanceforTransportEmployees(WebDriver driver) {
		super(driver);
	...
	public void ClickTransportAllowanceGiven() {
		TransportAllowanceGiven.click();
	}
