...
public class EditOthersLeaveEncashmentOnRetirement extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement Others;
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[27]/td[2]/a")
	WebElement LeaveEncashmentOnRetirement;
	...
	public EditOthersLeaveEncashmentOnRetirement(WebDriver driver) {
		super(driver);
	...
	public void ClickLeaveEncashmentOnRetirement() {
		LeaveEncashmentOnRetirement.click();
	}
