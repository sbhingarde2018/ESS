...
public class CreateBonusDefinitionMaxBonusCalculateModeofPaymentChequePTonBonusRespectiveMonth extends BasePage {
	...
	public CreateBonusDefinitionMaxBonusCalculateModeofPaymentChequePTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
