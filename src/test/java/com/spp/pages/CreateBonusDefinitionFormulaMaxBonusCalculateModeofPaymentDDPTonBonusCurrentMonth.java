...
public class CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentDDPTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentDDPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
