...
public class CreateBonusDefinitionFormulaCalculateModeofPaymentChequePTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaCalculateModeofPaymentChequePTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
