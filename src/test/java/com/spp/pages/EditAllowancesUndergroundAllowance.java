...
public class EditAllowancesUndergroundAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[74]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement UnderGroundAllowanceGiven;
	...
	public EditAllowancesUndergroundAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickUnderGroundAllowanceGiven() {
		UnderGroundAllowanceGiven.click();
	}
