...
public class SalaryHeadValidation extends BasePage {
	@FindBy(id="master")
	...
	@FindBy(id="salary_head_head_name-error")
	WebElement headNameValidationMessage;
	@FindBy(id="salary_head_short_name-error")
	WebElement shortNameValidationMessage;
	@FindBy(xpath="//strong[contains(text(),'2 errors')]")
	WebElement headNameErrorMessage;

	public SalaryHeadValidation(WebDriver driver){
		super(driver);
	...
	public String getHeadNameMessage(){
		return headNameValidationMessage.getText();
	}
	public String getShortNameMessage(){
		return shortNameValidationMessage.getText();
	}
	public String getHeadNameErrorMessage(){
		return headNameErrorMessage.getText();
	}
