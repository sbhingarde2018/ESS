...
public class CreateBonusDefinitionMaxBonusAllowManualEditingConsideremployeeswithminimumworking extends BasePage{
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Eid4')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionMaxBonusAllowManualEditingConsideremployeeswithminimumworking(WebDriver driver) {
		super(driver);
