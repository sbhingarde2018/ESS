...
public class SelectLimitUncongenialClimateAllowance extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[42]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement UncongenialAllowanceGiven;
	...
	public SelectLimitUncongenialClimateAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickUncongenialAllowanceGiven() {
		UncongenialAllowanceGiven.click();
	}
