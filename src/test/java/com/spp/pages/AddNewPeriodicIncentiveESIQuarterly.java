...
public class AddNewPeriodicIncentiveESIQuarterly extends BasePage{
	@FindBy(id="salary")
	...
	WebElement ESI;
	@FindBy(xpath="//*[@id=\"new_standing_instruction_detail\"]/div[4]/table[2]/tbody/tr/td[3]/label/input")
	WebElement Quarterly;
	@FindBy(id="p_payment_3")
	WebElement AddPremiumPaymentQuarterly;
	...
	public AddNewPeriodicIncentiveESIQuarterly(WebDriver driver){
		super(driver);
	...
	public void clickQuarterly() throws Exception{
		Quarterly.click();
	}
	public void addpremiumpaymentquarterly() {
		AddPremiumPaymentQuarterly.click();
	}
