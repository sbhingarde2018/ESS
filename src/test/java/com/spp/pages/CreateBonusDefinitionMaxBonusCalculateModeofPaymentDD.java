...
public class CreateBonusDefinitionMaxBonusCalculateModeofPaymentDD extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusCalculateModeofPaymentDD(WebDriver driver) {
		super(driver);
