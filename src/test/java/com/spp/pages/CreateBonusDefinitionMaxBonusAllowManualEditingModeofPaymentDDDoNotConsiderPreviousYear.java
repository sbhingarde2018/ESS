...
public class CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentDDDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusAllowManualEditingModeofPaymentDDDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
