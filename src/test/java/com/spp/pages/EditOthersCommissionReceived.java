...
public class EditOthersCommissionReceived extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement Others;
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[5]/td[2]/a")
	WebElement CommissionReceived;
	...
	public EditOthersCommissionReceived(WebDriver driver) {
		super(driver);
	...
	public void ClickCommissionReceived() {
		CommissionReceived.click();
	}
