...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentChequePTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionwithminimumworkingModeofPaymentChequePTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
