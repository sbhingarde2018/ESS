...
public class CreateBonusDefinitionConsideremployeeswithminimumworkingMaxBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionConsideremployeeswithminimumworkingMaxBonusCurrentMonth(WebDriver driver) {
		super(driver);
