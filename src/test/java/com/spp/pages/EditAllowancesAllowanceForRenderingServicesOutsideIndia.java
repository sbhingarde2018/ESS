...
public class EditAllowancesAllowanceForRenderingServicesOutsideIndia extends BasePage{
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[95]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement RenderingAllowanceGiven;
	...
	public EditAllowancesAllowanceForRenderingServicesOutsideIndia(WebDriver driver) {
		super(driver);
	...
	public void ClickRenderingAllowanceGiven() {
		RenderingAllowanceGiven.click();
	}
