...
public class CreateBonusDefinitionMaxBonusCalculateModeofPaymentBankAdviseRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusCalculateModeofPaymentBankAdviseRespectiveMonth(WebDriver driver) {
		super(driver);
