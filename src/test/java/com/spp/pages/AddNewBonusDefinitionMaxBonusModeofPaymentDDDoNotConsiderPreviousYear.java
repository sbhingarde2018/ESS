...
public class AddNewBonusDefinitionMaxBonusModeofPaymentDDDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionMaxBonusModeofPaymentDDDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
