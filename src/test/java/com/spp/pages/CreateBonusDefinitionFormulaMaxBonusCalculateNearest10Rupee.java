...
public class CreateBonusDefinitionFormulaMaxBonusCalculateNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Diwali221')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	
	public CreateBonusDefinitionFormulaMaxBonusCalculateNearest10Rupee(WebDriver driver) {
		super(driver);
