...
public class EditSalaryGroupRoundOffHigherRupee extends BasePage{
	@FindBy(id="master")
	WebElement masterlink;
	@FindBy(xpath="//a[text()='Salary Structure']")
	WebElement salarystructurelink;
	@FindBy(xpath="//table/tbody/tr/td[contains(text(),'Structure_3')]/parent::tr/td[3]/a")
	...
	public EditSalaryGroupRoundOffHigherRupee(WebDriver driver){
		super(driver);
