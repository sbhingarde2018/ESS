...
public class EditAllowancesBorderAreaRemoteAreaAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[57]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	...
	public EditAllowancesBorderAreaRemoteAreaAllowance(WebDriver driver) {
		super(driver);
