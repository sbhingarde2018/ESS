...
public class AddNewBonusDefinitionMaxBonusModeofPaymentDDPTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionMaxBonusModeofPaymentDDPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
