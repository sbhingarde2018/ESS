...
public class EditVIADeductionsMedicalinsurancepremiumpaid80DForparentsIncaseifVeryseniorcitizen extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(id="six_a_deduction_sub_attr_2_senior")
	WebElement CheckBoxSenior;
	@FindBy(id="six_a_deduction_sub_attr_2_health_insurance_premium")
	WebElement HealthInsurancePremium;
	@FindBy(id="six_a_deduction_sub_attr_2_preventive_checkup_amount")
	WebElement PreventiveHealthCheckup;
	@FindBy(id="six_a_deduction_sub_attr_2_senior_medical_expenditure")
	WebElement MedicalExpenditure;
	@FindBy (id="compute")
	...
	public EditVIADeductionsMedicalinsurancepremiumpaid80DForparentsIncaseifVeryseniorcitizen(WebDriver driver) {
		super(driver);
	...
	public void EnterMedicalExpenditure(String value) {
		MedicalExpenditure.sendKeys(value);
	}
}
