...
public class CreateArrearIndependentOfSalaryInstrumentsRestrictNegative extends BasePage{
	@FindBy(id="salary") 
...
public CreateArrearIndependentOfSalaryInstrumentsRestrictNegative(WebDriver driver) {
		super(driver);
