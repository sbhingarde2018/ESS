...
public class CreateLoanAmountNoOfInstallmentsHigher10rupeeNoRecovery extends BasePage{
	@FindBy(id="salary")
...
public CreateLoanAmountNoOfInstallmentsHigher10rupeeNoRecovery(WebDriver driver) {
	super(driver);
