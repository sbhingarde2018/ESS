...
public class CreateBonusDefinitionConsideremployeeswithminimumworkingModeofPaymentBankAdvise extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri13')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionConsideremployeeswithminimumworkingModeofPaymentBankAdvise(WebDriver driver) {
		super(driver);
