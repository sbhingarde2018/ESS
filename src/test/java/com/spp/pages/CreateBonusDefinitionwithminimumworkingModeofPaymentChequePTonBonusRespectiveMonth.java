...
public class CreateBonusDefinitionwithminimumworkingModeofPaymentChequePTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionwithminimumworkingModeofPaymentChequePTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
