...
public class AddNewBonusDefinitionMaxBonusPTonBonusRespectiveMonthDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionMaxBonusPTonBonusRespectiveMonthDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
