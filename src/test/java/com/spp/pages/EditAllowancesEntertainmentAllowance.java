...
public class EditAllowancesEntertainmentAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[91]/td[contains(text(),'Allowance Given')]/parent::tr/td/a")
	WebElement EntertainmentAllowanceGiven;
	...
	public EditAllowancesEntertainmentAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickEntertainmentAllowanceGiven() {
		EntertainmentAllowanceGiven.click();
	}
