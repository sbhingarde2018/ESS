...
public class CreateBonusDefinitionMaxBonusConsideremployeeswithminimumworkingModeofPaymentCheque extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionMaxBonusConsideremployeeswithminimumworkingModeofPaymentCheque(WebDriver driver) {
		super(driver);
