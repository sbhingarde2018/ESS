...
public class CreateBonusDefinitionFormulaCalculateModeofPaymentCheque extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri20')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionFormulaCalculateModeofPaymentCheque(WebDriver driver) {
		super(driver);
