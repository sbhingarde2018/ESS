...
public class EditOthersPensionReceived extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	public EditOthersPensionReceived(WebDriver driver) {
		super(driver);
	...
	public void ClickPensionReceived() {
		PensionReceived.click();
	}
