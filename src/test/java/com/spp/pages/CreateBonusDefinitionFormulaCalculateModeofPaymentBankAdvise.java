...
public class CreateBonusDefinitionFormulaCalculateModeofPaymentBankAdvise extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Navratri12')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	public CreateBonusDefinitionFormulaCalculateModeofPaymentBankAdvise(WebDriver driver) {
		super(driver);
