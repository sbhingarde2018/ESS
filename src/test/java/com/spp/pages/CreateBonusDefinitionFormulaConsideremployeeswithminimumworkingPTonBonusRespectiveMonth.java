...
public class CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingPTonBonusRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingPTonBonusRespectiveMonth(WebDriver driver) {
		super(driver);
