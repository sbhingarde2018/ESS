...
public class CreateBonusDefinitionConsideremployeeswithminimumworkingModeofPaymentDDRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionConsideremployeeswithminimumworkingModeofPaymentDDRespectiveMonth(WebDriver driver) {
		super(driver);
