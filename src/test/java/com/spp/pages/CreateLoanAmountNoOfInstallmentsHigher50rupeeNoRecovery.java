...
public class CreateLoanAmountNoOfInstallmentsHigher50rupeeNoRecovery extends BasePage{
	@FindBy(id="salary")
...
public CreateLoanAmountNoOfInstallmentsHigher50rupeeNoRecovery(WebDriver driver) {
	super(driver);
