...
public class AddNewBonusDefinitionFormulaModeofPaymentDDDoNotConsiderPreviousYear extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionFormulaModeofPaymentDDDoNotConsiderPreviousYear(WebDriver driver) {
		super(driver);
