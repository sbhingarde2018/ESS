...
public class CreateBonusDefinitionMaxBonusConsideremployeeswithminimumworkingCalculateNearest10Rupee extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	@FindBy(xpath="//div/table/tbody/tr/td[contains(text(),'Diwali219')]/parent::tr/td[4]/a/img")
	WebElement DeleteButton;
	
	
	public CreateBonusDefinitionMaxBonusConsideremployeeswithminimumworkingCalculateNearest10Rupee(WebDriver driver) {
		super(driver);
