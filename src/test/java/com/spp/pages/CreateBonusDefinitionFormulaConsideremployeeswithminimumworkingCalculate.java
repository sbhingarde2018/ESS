...
public class CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingCalculate extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaConsideremployeeswithminimumworkingCalculate(WebDriver driver) {
		super(driver);
