...
public class CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentCashRespectiveMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public CreateBonusDefinitionFormulaMaxBonusCalculateModeofPaymentCashRespectiveMonth(WebDriver driver) {
		super(driver);
