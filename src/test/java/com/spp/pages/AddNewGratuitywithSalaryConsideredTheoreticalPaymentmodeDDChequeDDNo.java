...
public class AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeDDChequeDDNo extends BasePage {
	@FindBy(id="salary")
	...
	public AddNewGratuitywithSalaryConsideredTheoreticalPaymentmodeDDChequeDDNo(WebDriver driver) {
		super(driver);
