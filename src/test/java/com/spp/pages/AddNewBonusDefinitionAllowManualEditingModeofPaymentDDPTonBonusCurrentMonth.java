...
public class AddNewBonusDefinitionAllowManualEditingModeofPaymentDDPTonBonusCurrentMonth extends BasePage{
	@FindBy(id="salary") 
	WebElement Salary;
	...
	public AddNewBonusDefinitionAllowManualEditingModeofPaymentDDPTonBonusCurrentMonth(WebDriver driver) {
		super(driver);
