...
public class ExportToExcelBulkReimbursementErrorLog extends BasePage {

	public ExportToExcelBulkReimbursementErrorLog(WebDriver driver) {
		super(driver);
	...
	public void selectExportToExcelButton() {
