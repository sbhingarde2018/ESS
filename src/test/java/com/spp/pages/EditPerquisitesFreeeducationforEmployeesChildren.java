...
public class EditPerquisitesFreeeducationforEmployeesChildren extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	@FindBy(xpath="//*[@id=\"references\"]/table/tbody/tr[23]/td[3]/a")
	WebElement FreeEducationEmp;
	...
	public EditPerquisitesFreeeducationforEmployeesChildren(WebDriver driver) {
		super(driver);
	...
	public void ClickFreeEducationEmp() {
		FreeEducationEmp.click();
	}
