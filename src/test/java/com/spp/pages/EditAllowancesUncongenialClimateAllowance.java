...
public class EditAllowancesUncongenialClimateAllowance extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	WebElement ClimateAllowanceGiven;
	...
	public EditAllowancesUncongenialClimateAllowance(WebDriver driver) {
		super(driver);
	...
	public void ClickClimateAllowanceGiven() {
		ClimateAllowanceGiven.click();
	}
