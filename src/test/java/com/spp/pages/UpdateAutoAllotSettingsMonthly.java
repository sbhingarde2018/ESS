...
public class UpdateAutoAllotSettingsMonthly extends BasePage{
	@FindBy(id="master")
   ...
   // @FindBy(xpath="//*[@id=\"leave_policy_setting_details\"]/div[2]/table/tbody/tr/td[2][contains(text(),'Earned')]/parent::tr/td[3]/a")
	@FindBy(xpath="//*[@id=\"leave_policy_setting_details\"]/div[2]/table/tbody/tr/td[2][contains(text(),'Leave')]/parent::tr/td[3]/a")
    ...
    WebElement AllotOn;
    @FindBy(xpath="//*[@id=\"auto_leave_allotment_div\"]/table/tbody/tr[4]/td[1]/div[1]/select")
    WebElement AsPerMonth;
	...
	public void SelectAsPerMonth(String value) {
		dropDownSelect(AsPerMonth, value);
	}
