...
public class GenerateTDSReportReporttypeStatementofTotalIncome extends BasePage {
	@FindBy(id="tds")
	WebElement TDS;
	...
	public GenerateTDSReportReporttypeStatementofTotalIncome(WebDriver driver) {
		super(driver);
